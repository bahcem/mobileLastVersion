...
class PaymentMethodList {
  ...
  PaymentMethodList(BuildContext _context) {
    ...
    this._cashList = [
      new PaymentMethod("cod", 'Nakit', 'Kapıda nakit ödeme', "/CashOnDelivery",
          "assets/img/cash-payment.png"),
      new PaymentMethod("credit_card", 'Kredi Kartı', 'Kapıda kredi kartı',
          "/CashOnDelivery", "assets/img/credit-card.png"),
    ];
    this._pickupList = [
      new PaymentMethod(
          "pop",
